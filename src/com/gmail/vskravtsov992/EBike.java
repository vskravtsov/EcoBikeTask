...
public class EBike extends Ecobike {
	...
	public EBike(String brand, int weight, boolean lights, String color, int price, int maxSpeed, int batteryCap) {
	...
	public String toString() {
		return "E-BIKE " + this.getBrand() + " with " + this.getBatteryCap() + " mAh battery and "
